...
// Simple markdown-like rendering: just handle newlines and code inline
...
<template>
  <div class="flex flex-col h-full bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
    <!-- Header -->
    ...
    <div ref="messagesEl" class="flex-1 overflow-y-auto p-4 space-y-3 min-h-0">
      ...
      <!-- Loading dots -->
      <div v-if="isLoading && messages[messages.length-1]?.streaming" class="hidden"></div>
    </div>
